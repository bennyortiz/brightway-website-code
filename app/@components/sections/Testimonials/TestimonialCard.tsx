...
const TestimonialCard = ({
  ...
  return (
    <div
      className={`${transparent ? 'bg-transparent' : 'bg-white'} rounded-2xl shadow-lg h-full p-8 flex flex-col relative 
    ...
    >
      ...
      <div className="relative">
        <span className="absolute -top-2 left-0 text-4xl text-primary">&quot;</span>
      </div>
      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 flex items-center">
          ...
          <div className="ml-4">
            <p className="font-bold text-gray-900" aria-label="Testimonial by">
              {author}
            </p>
