      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                If you&apos;re not completely satisfied with our service, we&apos;ll come back and re-clean
                the areas in question at no additional cost. Your happiness is our priority.
              </p>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-gray-700 mb-6 text-lg">
                We carry comprehensive insurance coverage, including liability and workers&apos;
                compensation. Your property and peace of mind are protected.
              </p>
        ...
        <div className="bg-primary rounded-2xl p-8 md:p-10 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            <StatItem value={siteConfig.business.satisfaction} label="Client Satisfaction" />
            <StatItem value={`${yearsInBusiness}+`} label="Years Experience" />
            <StatItem value={`${siteConfig.business.clientsServed}+`} label="Clients Served" />
            <StatItem value={siteConfig.business.servicesCount} label="Service Options" />
          </div>
