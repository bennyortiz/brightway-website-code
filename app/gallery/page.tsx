...
export default function GalleryPage() {
  return (
    <MainLayout>
      ...
      <Section spacing="lg">
        <Grid columns={{ default: 1, sm: 2, lg: 3 }} gap={8}>
      ...
      <Section spacing="xl" background="bg-gray-50" className="text-center">
        <h2 className="text-3xl font-bold mb-12">Why Choose Our Cleaning Services</h2>

        <Grid columns={{ default: 1, md: 2, lg: 4 }} gap={8}>
          <Column className="bg-white p-8 rounded-xl shadow-sm">
      ...
      {/* CTA Section */}
      <Section spacing="lg" background="bg-primary" className="text-white text-center">
