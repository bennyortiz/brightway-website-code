      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2>Introduction</h2>
            <p>
              Brightway Cleaning ("we," "our," or "us") respects your privacy and is committed to protecting your personal information. 
            ...
            <p>
              ...
              and personalize content. You can set your browser to refuse cookies, but this may limit functionality of our website.
            </p>
            ...
            <h2>Contact Us</h2>
            <p>
              If you have questions or concerns about this Privacy Policy or our privacy practices, please contact us at:<br />
