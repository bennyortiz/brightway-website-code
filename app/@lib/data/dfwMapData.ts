...
export const dfwMapData: DFWMapRegion[] = [
  {
    ...
    coverageLevel: 'full',
    description:
      'Premium commercial cleaning services for North Dallas businesses, including Addison, Richardson, and Plano.',
  ...
  },
  {
    ...
    coverageLevel: 'full',
    description:
      'Premier cleaning services for Downtown Dallas high-rises, office buildings, and commercial spaces.',
  ...
  },
  {
    ...
    coverageLevel: 'full',
    description:
      'Comprehensive cleaning solutions for East Dallas businesses, including Lakewood, Casa Linda, and White Rock Lake areas.',
  ...
  },
  {
    ...
    description:
      'Professional cleaning services for Garland, Plano and surrounding areas, ideal for office parks and retail spaces.',
  ...
  },
  {
    ...
    coverageLevel: 'full',
    description:
      'Full-service commercial cleaning for Irving businesses, including Las Colinas and Irving Convention Center area.',
  ...
  },
  {
    ...
    coverageLevel: 'partial',
    description:
      'Specialized cleaning services for Arlington commercial spaces, including entertainment and shopping districts.',
    keyLocations: [
      'AT&T Stadium Area',
      'UTA Area',
      'Arlington Highlands',
